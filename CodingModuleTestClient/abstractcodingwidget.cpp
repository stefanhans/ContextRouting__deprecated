...
AbstractCodingWidget::AbstractCodingWidget(QWidget *parent)
    : QTabWidget(parent)
{
    qDebug() << "AbstractCodingWidget::AbstractCodingWidget(QWidget *parent)";
...
void AbstractCodingWidget::setNamespaceUri(QString namespaceUri) {
...
bool AbstractCodingWidget::loadFile(QString fileName) {
    qDebug() << "AbstractCodingWidget::loadFile(QString fileName)";
    ...
    // GUI
    AbstractCodingReader *reader = new AbstractCodingReader();
...
void AbstractCodingWidget::loadGuiInteraction() {
    qDebug() << "AbstractCodingWidget::loadGuiInteraction()";
...
void AbstractCodingWidget::addNextLayout(QLayout *nextLayout) {
    qDebug() << "AbstractCodingWidget::addNextLayout(nextLayout)";

    guiLayout->addLayout(nextLayout);
}

void AbstractCodingWidget::saveXmlFile(bool b) {
    qDebug() << "AbstractCodingWidget::saveXmlFile()";
...
void AbstractCodingWidget::validateXml(bool b) {
    qDebug() << "AbstractCodingWidget::validateXml(bool b)";
...
void AbstractCodingWidget::saveXsdFile(bool b) {
    qDebug() << "AbstractCodingWidget::saveXsdFile(" << dtdFileLnEd->text() << ")";
...
void AbstractCodingWidget::validateXsd(bool b) {
    qDebug() << "AbstractCodingWidget::validateXsd(bool b)";
