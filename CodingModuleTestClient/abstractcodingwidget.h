#ifndef ABSTRACTCODINGWIDGET_H
#define ABSTRACTCODINGWIDGET_H
...
class AbstractCodingWidget : public QTabWidget
{
    Q_OBJECT

public:
    AbstractCodingWidget(QWidget *parent = 0);
    ~AbstractCodingWidget(){}
